...
[LLVM binary builds](http://releases.llvm.org/download.html) An LLVM version 12.0.0 should be used: https://github.com/llvm/llvm-project/releases/tag/llvmorg-12.0.0
