...
{
    return (m_propertyID == val.m_propertyID && m_value == val.m_value && m_senderTaskID == val.m_senderTaskID &&
...
{
    return _stream << "propertyID=" << val.m_propertyID << "; value=" << val.m_value
